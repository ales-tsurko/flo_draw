...
impl<TPixel, TEdgeDescriptor, TPlanner> PixelProgram
    for BasicSpriteProgram<TPixel, TEdgeDescriptor, TPlanner>
where
    TEdgeDescriptor: 'static + EdgeDescriptor,
    ...
    TPlanner: Send + Sync + ScanPlanner<Edge = TEdgeDescriptor>,
{
    ...
    fn draw_pixels(
        ...
        let sprite_xrange = sprite_transform.pixel_x_to_source_x(x_range.start)
            ..sprite_transform.pixel_x_to_source_x(x_range.end);
