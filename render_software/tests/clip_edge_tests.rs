...
pub fn clip_big_rectangle() {
    ...
    for y_pos in 0..400 {
        ...
        if y_pos < 200.0 || y_pos >= 300.0 {
            ...
            assert!(
                intercepts[0][0].x_pos == 100.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
            assert!(
                intercepts[0][1].x_pos == 200.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
            ...
            assert!(
                intercepts[0][1].x_pos == 125.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
            assert!(
                intercepts[0][2].x_pos == 175.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
            assert!(
                intercepts[0][3].x_pos == 200.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
...
pub fn clip_inner_rectangle_1() {
    ...
    for y_pos in 0..400 {
        ...
        if y_pos < 200.0 || y_pos >= 300.0 {
            ...
            assert!(
                intercepts[0][0].x_pos == 110.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
            assert!(
                intercepts[0][1].x_pos == 190.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
...
pub fn clip_inner_rectangle_2() {
    ...
    for y_pos in 0..400 {
        ...
        if y_pos < 200.0 || y_pos >= 300.0 {
            ...
            assert!(
                intercepts[0][0].x_pos == 125.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
            assert!(
                intercepts[0][1].x_pos == 175.0,
                "At ypos {}, intercepts are {:?}",
                y_pos,
                intercepts
            );
